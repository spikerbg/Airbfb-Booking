...
export default function Header() {
  return (
    <div>
      <header className='p-4 align-middle flex justify-between'>
        ...
        <div className='flex items-center gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-sm shadow-gray-300 '>
